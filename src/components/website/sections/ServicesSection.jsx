        ...
        {SERVICES.map((service, i) => (
          <FadeIn key={service.num} delay={i * 0.1}>
            <div
              ...
              style={i === SERVICES.length - 1 ? { borderBottom: '1px solid rgba(12,12,12,0.15)' } : undefined}
            >
              <span
              ...
              <div>
                ...
                <p
                  className="mt-2 max-w-2xl font-light leading-relaxed opacity-60 text-[#0C0C0C]"
